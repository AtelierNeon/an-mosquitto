...
PROJECT_MOSQUITTO_WITH_LIBWEBSOCKETS="${MY_PROJECT_MOSQUITTO_WITH_LIBWEBSOCKETS:=OFF}"
PROJECT_MOSQUITTO_WITH_SHARED_CJSON="${MY_PROJECT_MOSQUITTO_WITH_SHARED_CJSON:=OFF}"
PROJECT_MOSQUITTO_WITH_SHARED_LIBRARIES="${MY_PROJECT_MOSQUITTO_WITH_SHARED_LIBRARIES:=OFF}"
PROJECT_MOSQUITTO_WITH_SHARED_LIBWEBSOCKETS="${MY_PROJECT_MOSQUITTO_WITH_SHARED_LIBWEBSOCKETS:=OFF}"
...
if [ "ON" = "$PROJECT_MOSQUITTO_WITH_LIBWEBSOCKETS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DMOSQUITTO_WITH_LIBWEBSOCKETS=$PROJECT_MOSQUITTO_WITH_LIBWEBSOCKETS")
fi
if [ "ON" = "$PROJECT_MOSQUITTO_WITH_SHARED_CJSON" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DMOSQUITTO_WITH_SHARED_CJSON=$PROJECT_MOSQUITTO_WITH_SHARED_CJSON")
fi
if [ "ON" = "$PROJECT_MOSQUITTO_WITH_SHARED_LIBRARIES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DMOSQUITTO_WITH_SHARED_LIBRARIES=$PROJECT_MOSQUITTO_WITH_SHARED_LIBRARIES")
fi
if [ "ON" = "$PROJECT_MOSQUITTO_WITH_SHARED_LIBWEBSOCKETS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DMOSQUITTO_WITH_SHARED_LIBWEBSOCKETS=$PROJECT_MOSQUITTO_WITH_SHARED_LIBWEBSOCKETS")
fi
...
echo "[$SYSTEM_PLATFORM] Component information: mosquitto with libwebsockets: $PROJECT_MOSQUITTO_WITH_LIBWEBSOCKETS"
echo "[$SYSTEM_PLATFORM] Component information: mosquitto with shared cJSON: $PROJECT_MOSQUITTO_WITH_SHARED_CJSON"
echo "[$SYSTEM_PLATFORM] Component information: mosquitto with shared libraries: $PROJECT_MOSQUITTO_WITH_SHARED_LIBRARIES"
echo "[$SYSTEM_PLATFORM] Component information: mosquitto with shared libwebsockets: $PROJECT_MOSQUITTO_WITH_SHARED_LIBWEBSOCKETS"
